                                ...
                                {isDropdownOpen && (
                                    <div className="absolute right-0 z-10 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                                        <div className="py-1">
                                            ...
                                            <a href="/Login" className="flex items-center px-4 py-2 text-red-500 hover:bg-red-100 hover:text-red-700">
                                                Keluar
                                                <span className="ml-2">
            ...
            {isMenuOpen && (
                <div className="absolute top-16 left-0 right-0 bg-white shadow-md z-20">
                    <nav className="px-2 pt-2 pb-4 space-y-1">
                        ...
                        <a href="#" className="block px-3 py-2 text-red-500 hover:bg-red-100 rounded">Keluar</a>
                    </nav>
                </div>
            )}
        </header>
