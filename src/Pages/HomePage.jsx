    ...
    return (
        <div className="bg-[#FFFDF3] min-h-screen mx-auto gap-11">
            ...
            <main className="container mx-auto px-4 py-8">
                ...
                {/* Newsletter Section */}
                <section className="flex justify-center items-center bg-[#fffdf3] py-10 md:py-16 bg-cover bg-center gap-6 md:gap-[32px] bg-[url('/img/bawah.svg')] md:rounded-md px-4 md:px-8 lg:px-16">
